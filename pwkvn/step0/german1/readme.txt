...
Start with version 22: ../../orig/pwk1-7VN_ansi_22.txt
python ../cp1252_utf8.py ../../orig/pwk1-7VN_ansi_22.txt temp_pwkvn_22.txt

========================================================================
temp_pwkvn_23.txt  Apply German corrections
Use the lines marked as  μ in ../german/gtext3_revised.txt
  
python ../cp1252_utf8.py ../german/gtext3_revised.txt temp_gtext3_revised.txt
 44 lines have μ
 17 are marked μ?  == these do not require change.
 NOTE:  Due to the insert of page299, the line-numbers do not match.
   Correspondence can be made, however.
   5527 new <p>{#kSatravRddhi#} f. µ?{%Zunahme an Kriegermacht%}
    corresponds to
   <p n="05527" pc="4-298-b"><hw>{#kSatravRddhi#}</hw> f. {%Zunahme an Kriegermacht%}

print changes:
1799 old <p>{#akSIrAkSArAlavaNa#} ...  Aez-²zendes
1799 new <p>{#akSIrAkSArAlavaNa#} ...  Aet-²zendes

14409 old <p>{#AsInanyAya#} Adj. {%wobei die siz-²zende ...
14409 new <p>{#AsInanyAya#} Adj. µ{%wobei die sit-²zende ...

python ../diff_to_changes.py temp_pwkvn_22.txt temp_pwkvn_23.txt change_23.txt
27 changes written to change_23.txt
check:
27 matches for "μ[^?]" in buffer: temp_gtext3_revised.txt

========================================================================
transfer temp_pwkvn_23.txt to orig in cp1252 encoding
python ../utf8_cp1252.py temp_pwkvn_23.txt ../../orig/pwk1-7VN_ansi_23.txt
