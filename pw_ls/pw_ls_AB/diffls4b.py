...
# more from diffls4
 ...
 "52136", "53447", "54574", "55874", "57022", 
 "57323", "65583", "68818", "71021", "71154", 
 "72670", "75775", "76839", "76963", "78307", 
 "79236", "79450", "80203", "81180", "83129", 
 "85935", "87001", "87763", "89441", "92808", 
 "93808", "94394", "96089", "97357", "98342", 
 "98691", "100131", "101225", "104035", "106821", 
 "108100", "112826", "114979", "116820", "117928", 
 "118825", "121032", "122811", "125322", "128304", 
 "129878","14953", "131635", "134145", 
 "2880", "16749", "17224", "23823", "25585", 
 "30119", "43318", "54314", "55032", "55514", 
 "62713", "64263", "69661", "70461", "80202", 
 "85531", "92713", "92727", "97787", "101208", 
 "130430", "131751", "134349", "134412", "135770", 
 "6753", "6930", "44564", "56698", "130874", 
 "131651", "108796", 
 #"", "", "", "", "", 
...
def write_diff_any_N(fileout,entries1,entries2):
 ...
 for ientry,entry1 in enumerate(entries1):
  ...
  #if first_L == L:
  # firstfound = True
  # print('BEGINNING with L=',first_L)
  if not firstfound:
   continue
  k1 = entry1.metad['k1']
  pc = entry1.metad['pc']
  ...
  if True:
   ...
   # now the pw entries
   # In this version, print only those lines that contain some pwnonmatches
   linesprint = []
   pwnonmatches_used = [False for ls1 in pwnonmatches]
   for iline,line in enumerate(entry1.datalines):
    for ils,ls in enumerate(pwnonmatches):
     if ls in line:  # ls is a substring of line
      pwnonmatches_used[ils] = True
      linesprint.append((iline,line))
      break
   if False in pwnonmatches_used:
    # use all datalines
    outarr.append('; NOTE: printing all datalines')
    linesprint = []
    for iline,line in enumerate(entry1.datalines):
     linesprint.append((iline,line))
   #for iline,line in enumerate(entry1.datalines):
   for iline,line in linesprint:
