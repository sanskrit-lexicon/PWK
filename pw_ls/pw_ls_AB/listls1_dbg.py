...
class Entry(object):
 ...
 def __init__(self,lines,linenum1,linenum2):
  ...
  self.Ldict[L] = self
  self.lsarr = []
  self.dbgcount = 0  # number of times a particular lsname occurs in this record
...
def update_abbrs(line,abbrs1,entry,lsdbg):
...
if __name__=="__main__":
 ...
 filebib = sys.argv[3]  # pwbib_input.txt
 fileout = sys.argv[4] #
 ...
 for entry in entries:
  for line in entry.datalines:
   update_abbrs(line,abbrs1,entry,lsdbg)
