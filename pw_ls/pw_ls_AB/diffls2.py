#-*- coding:utf-8 -*-
"""diffls2.py  only 1 pw ls, more than 1 ab ls.
"""
...
def write_diff_1_N(fileout,entries1,entries2):
 ...
 print(n1tot,'ls instances in cologne version')
 print(n2tot,'ls instances in AB version')
 print(ndiff,'different ls in 1,* case')
...
if __name__=="__main__": 
 ...
 for entry in entries2:
  markls(entry,'ab1')
 write_diff_1_N(fileout,entries1,entries2)
