# coding=utf-8
"""test2.py  see readme.txt for usage
...
def change_one_line(line):
 ...
 if x is None:
  newline = line
  # we can return newline here
  # This simplifies by removing the need for one level of indentation
  # When code gets too many levels of indentation, it becomes harder
  # to understand.
  return newline
 # Otherwise (i.e. x is NOT None), we try another way to get newline
 line1 = line
 pattern = r'({#.+#})'
 repl = r'%} \1 {%'
