...
def change_line(line):
 ...
 if m != None:
  repl1 = r'[[{%\1%}\2{%\3%}]]'  # put brackets sp we can see
  newline1 = re.sub(pattern,repl1,line)
 else:
  newline1 = newline
 return newline,newline1 
...
def make_changes(entries):
 ...
 for entry in entries:
  ...
  for iline,line in enumerate(entry.datalines):
   if n >= 10: break
   newline,newline1 = change_line(line)
   if newline == line:
