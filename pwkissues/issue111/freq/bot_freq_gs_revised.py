...
def kew_extra():
 lines = []
 lines.append('Acacia,sirissa,-1')
 #lines.append()
 return lines
if __name__=="__main__":
 filein = sys.argv[1] #  bot_freq_pw_3.txt
 ...
 lines1_extra = kew_extra()
 print(len(lines1_extra),"extra lines added to",filein1)
 for line in lines1_extra:
  lines1.append(line)
