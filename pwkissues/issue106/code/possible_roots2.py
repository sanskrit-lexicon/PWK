...
def make_changes(lines):
 ...
 # regex6: in text before broken bar, in {#X#} X ends with consonant.
 regex6 = r'[*]?{#[^#]*[kKgGNcCjJYwWqQRtTdDnpPbBmyrlvSzsh|]#}¦'

 changes = [] # 

 for iline,line in enumerate(lines):
  m = re.search(r'^<L>(2.....)<',line)
  if m == None:
   continue
  # we are in pwkvn section 
  metaline = line
  iline1 = iline + 1
